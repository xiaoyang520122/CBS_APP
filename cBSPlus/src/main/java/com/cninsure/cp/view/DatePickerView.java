...
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        //被选中的数字颜色
        mPaint.setColor(Color.parseColor("#ffffda53"));//ContextCompat.getColor(context, R.color.color_gold)
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        //未选中的数字颜色
        nPaint.setColor(Color.parseColor("#ffdcdcdc"));//#B0B0B0 //ContextCompat.getColor(context, R.color.color_text_unselected)
    }
