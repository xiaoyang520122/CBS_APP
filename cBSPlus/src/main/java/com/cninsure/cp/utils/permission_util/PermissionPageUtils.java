...
public class PermissionPageUtils {
	...
	public void jumpPermissionPage() {
		String names = Build.MANUFACTURER;
		// L.e(TAG, "jumpPermissionPage --- name : " + name);
		if ("HUAWEI".equals(names)) {
			goHuaWeiMainager();
		} else if ("vivo".equals(names)) {
			goVivoMainager();
		} else if ("OPPO".equals(names)) {
			goOppoMainager();
		} else if ("Coolpad".equals(names)) {
			goCoolpadMainager();
		} else if ("Meizu".equals(names)) {
			goMeizuMainager();
		} else if ("Xiaomi ".equals(names)) {
			goXiaoMiMainager();
		} else if ("Xiaomi".equals(names)) {
			goXiaoMiMainager();
		} else if ("samsung".equals(names)) {
			goSangXinMainager();
		} else if ("Sony".equals(names)) {
			goSonyMainager();
		} else if ("LG".equals(names)) {
			goLGMainager();
		} else {
			goIntentSetting();
		}
