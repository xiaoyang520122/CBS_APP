...
public class CargoPhotoChoiceActivity extends Activity {
...
//				PublicPhotoChoiceActivity.this.startActivity(intent);
				ImageDisplayUtil.displayByMyView(CargoPhotoChoiceActivity.this, fileNames.get(i));
			}
		});
	}
	...
	private void initView() {
		...
		cancelTv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				CargoPhotoChoiceActivity.this.finish();
			}
		});
	...
	private void handleAndSaveImag(int postion) {
		...
		ImageUtil.compressBmp(CargoPhotoChoiceActivity.this, data, PicturePath);// 压缩、水印、储存
	...
	private class MyGridAdapter extends BaseAdapter {
		...
		public View getView(final int itemPostion, View conview, ViewGroup arg2) {
			...
			if (conview != null) {
				...
				vh = new ViewHolder();
				conview = LayoutInflater.from(CargoPhotoChoiceActivity.this).inflate(R.layout.gride_image_view, null);
			...
			Glide.with(CargoPhotoChoiceActivity.this).load(imgPath).into(vh.img);
