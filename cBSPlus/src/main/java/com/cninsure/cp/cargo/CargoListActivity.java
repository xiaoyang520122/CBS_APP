...
public class CargoListActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static CargoListActivity instence;
    ...
    private void setUserCenterTvOnclick(){
        ...
        findViewById(R.id.dispersive_activity_V_LTV).setOnClickListener(v -> {
            //外部车童登录，跳转到外部车童界面
//            Intent intent=new Intent(CargoListActivity.this, CtCenterActivity.class);
