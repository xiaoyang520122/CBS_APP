...
public class WorkOrderActivtyhelp {
...
//	private String[] exlistTitleArr=new String[]{"人车合影照","事故现场照","标的车定损照","财产损失照","人伤损失照","事故单证照","行驶证照","驾驶证照"};
	...
	private WorkOrderActivtyhelp(){}
	
	public WorkOrderActivtyhelp(WorkOrderActivty workOrderActivty, View uploadView,WorkType photoType,WorkPhotos workphoto) {
	...
	private void redHistoryChiocePhoto(){
	 ...
	 class PhotoExpandablelistAdapter extends BaseExpandableListAdapter {
		 ...
		 public PhotoExpandablelistAdapter(){
			 adapters=new HashMap<String, WorkOrderActivtyhelp.MyParkGalleryAdapter>(8);
		 }
