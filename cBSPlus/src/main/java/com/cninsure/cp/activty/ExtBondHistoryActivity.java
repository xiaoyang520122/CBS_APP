 ...
 * usefuLness: CBS_APP
 */
public class ExtBondHistoryActivity extends BaseActivity {

    @ViewInject(R.id.extract_history_Back)
    private TextView backTv;  //返回按钮
    @ViewInject(R.id.extract_history_ListView)
    private ListView listView; //申请列表
