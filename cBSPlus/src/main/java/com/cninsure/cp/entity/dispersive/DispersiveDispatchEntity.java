...
public class DispersiveDispatchEntity implements Serializable {

    public DispersiveDispatchData data;
    public String msg;  //
    ...
    public static class DispersiveDispatchItem implements Serializable {
        public long id;
        /**
         * 案件标识(案件编号）
         */
